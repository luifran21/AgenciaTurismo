<%-- 
    ...
    Created on : 10-dic-2021, 8:06:56
    Author     : Luifran
--%>
...
<html lang="es">
    ...
    <body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <div class="contenedor-form">
                    <h2 style="text-align: center; margin-bottom: 2%;">Agregar Servicio</h2>
        <form action="SvServicio" method="POST">
            ...
            <div class="mb-3 row">
                <label for="fecha"  class="col-sm-2 col-form-label">Fecha de Servicio</label>
                <div class="col-sm-4">
                    <input class="form-control" type="date" name="fecha" required>    
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nombre" class="col-sm-2 col-form-label">Costo de Servicio</label>
                <div class="col-sm-4">
                    <input class="form-control" type="number" name="costo" step="0.01" required>    
                </div>
            </div>
